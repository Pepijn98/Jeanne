package dev.vdbroek.jeanne.commands.moderation
            ...
            when (args[0]) {
                "prefix" -> {
                    ...
                    if (prefixArgs.isEmpty()) {
                        var prefix = guild?.prefix ?: Jeanne.config.prefix
                        if (prefix == "%mention%")
                    ...
                    if (newPrefix == "reset" || newPrefix == "default")
                        newPrefix = Jeanne.config.prefix
                ...
                "welcome" -> {
                    ...
                    if (welcomeArgs[0] == "disable") {
                        ...
                        if (noEntry) {
                            DatabaseManager.guilds.insertOne(
                                Guild(
                                    e.guild.id,
