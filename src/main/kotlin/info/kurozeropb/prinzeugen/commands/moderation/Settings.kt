package info.kurozeropb.prinzeugen.commands.moderation

import info.kurozeropb.prinzeugen.Guild
            ...
            when (args[0]) {
                "prefix" -> {
                    ...
                    if (prefixArgs.isEmpty()) {
                        var prefix = guild?.prefix ?: Prinz.config.prefix
                        if (prefix == "%mention%")
                ...
                "check" -> {
                    ...
                    if (checkArgs.isEmpty()) {
                        e.reply("Please specify a setting to check, visit the website (https://prinz-eugen.info/settings) to see which settings you can check")
                        return
                    }
                    ...
                    when(checkArgs[0]) {
                        ...
                        else -> e.reply("This is not a valid setting to check, visit the website (https://prinz-eugen.info/settings) to see which settings you can check")
                    }
                }
                else -> e.reply("That is not a valid setting, visit the website (https://prinz-eugen.info/settings) to see which settings you can change")
            }
        }
    }
}
