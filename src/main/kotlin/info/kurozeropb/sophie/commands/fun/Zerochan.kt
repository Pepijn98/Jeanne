...
class Zerochan : Command(
    ...
    override suspend fun execute(args: List<String>, e: MessageReceivedEvent) {
        try {
            ...
            var xmlResponse = Sophie.httpClient.newCall(xmlRequest).execute()
            ...
            if (xmlUrl.contains("?xml=true").not()) {
                ...
                xmlResponse = Sophie.httpClient.newCall(xmlRequest).execute()
            }
            ...
            val jsonResponse = Sophie.httpClient.newCall(jsonRequest).execute()
